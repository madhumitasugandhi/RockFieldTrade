...
<div class="portfolio-col">
    ...
    <!--            <div class="card h-90">-->
    <!--                <a class="hover-box" style="text-decoration: none;" href="/fmarket">-->
    <!--                    <div class="dot-full">-->
    <!--                    </div>-->
    <!--                    <div class="card-body mb-5">-->
    <!--                        <h1 class="card-img-top">What is fundamental market?</h1>-->
    <!--                    </div>-->
    <!--                </a>-->
    <!--                <div class="next text-center">-->
    <!--                    <a href="/fmarket"><span><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>-->
    <!--                </div>-->
    <!--            </div>-->
    <!--        </div>-->
    <!--        <div class="col-lg-6 col-sm-6 portfolio-item">-->
    <!--            <div class="card h-60">-->
    <!--                <a class="hover-box" style="text-decoration: none;" href="/lots&leverages">-->
    <!--                    <div class="dot-full">-->

    <!--                    </div>-->
    <!--                    <div class="card-body">-->
    <!--                        <h1 class="card-img-top">Lots & Leverage</h1>-->
    <!--                    </div>-->
    <!--                    <div class="next text-center">-->
    <!--                        <a href="/lots&leverages"><span><i class="fa fa-angle-right"-->
      ...
      <div class="z1y6k2-cards-row">
        ...
        <div class="p4s7j2-custom-card" style="background-image: url('assets/images/ver1.jpg');">
          <div class="q5u3w8-card-overlay">
            <div class="a1b9c7-card-title">What is fundamental market?</div>
            <a href="/fmarket" class="s4v1u8-view-btn">View More</a>
          </div>
        </div>

        <div class="p4s7j2-custom-card" style="background-image: url('assets/images/ver2.jpg');">
          <div class="q5u3w8-card-overlay">
            <div class="a1b9c7-card-title">Lots & Leverage</div>
            <a href="/lots&leverages" class="s4v1u8-view-btn">View More</a>
          </div>
        </div>
