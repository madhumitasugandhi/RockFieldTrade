...
<div class="portfolio-col">
    ...
    <!--            <div class="card h-90">-->
    <!--                <a class="hover-box" style="text-decoration: none;" href="/techanalysis">-->
    <!--                    <div class="dot-full">-->
    <!--                    </div>-->
    <!--                    <div class="card-body mb-5">-->
    <!--                        <h1 class="card-img-top">What is technical analysis?</h1>-->
    <!--                    </div>-->
    <!--                </a>-->
    <!--                <div class="next text-center">-->
    <!--                    <a href="/techanalysis"><span><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>-->
    <!--                </div>-->
    <!--            </div>-->
    <!--        </div>-->
    <!--        <div class="col-lg-6 col-sm-6 text-center portfolio-item">-->
    <!--            <div class="card h-90">-->
    <!--                <a class="hover-box" style="text-decoration: none;" href="/support&resis">-->
    <!--                    <div class="dot-full">-->
    <!--                    </div>-->
    <!--                    <div class="card-body mb-5">-->
    <!--                        <h1 class="card-img-top">Support and resistance levels</h1>-->
    <!--                    </div>-->
    <!--                </a>-->
    <!--                <div class="next text-center">-->
    <!--                    <a href="/support&resis"><span><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>-->
    <!--                </div>-->
    <!--            </div>-->
    <!--        </div>-->
      ...
      <div class="z1y6k2-cards-row">
        ...
        <div class="p4s7j2-custom-card" style="background-image: url('assets/images/ver1.jpg');">
          <div class="q5u3w8-card-overlay">
            <div class="a1b9c7-card-title">What is technical analysis?</div>
            <a href="/techanalysis" class="s4v1u8-view-btn">View More</a>
          </div>
        </div>

        <div class="p4s7j2-custom-card" style="background-image: url('assets/images/ver2.jpg');">
          <div class="q5u3w8-card-overlay">
            <div class="a1b9c7-card-title">Support and resistance levels</div>
            <a href="/support&resis" class="s4v1u8-view-btn">View More</a>
          </div>
        </div>
