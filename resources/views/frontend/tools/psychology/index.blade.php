...
<div class="portfolio-col">
    ...
    <!--            <div class="card h-90">-->
    <!--                <a class="hover-box" style="text-decoration: none;" href="/trademistakes">-->
    <!--                    <div class="dot-full">-->
    <!--                    </div>-->
    <!--                    <div class="card-body mb-5">-->
    <!--                        <h1 class="card-img-top">Novice traders mistakes-->
    <!--                        </h1>-->
    <!--                    </div>-->
    <!--                </a>-->
    <!--                <div class="next text-center">-->
    <!--                    <a href="/trademistakes"><span><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>-->
    <!--                </div>-->
    <!--            </div>-->
    <!--        </div>-->
      ...
      <div class="z1y6k2-cards-row">
        ...
        <div class="p4s7j2-custom-card" style="background-image: url('assets/images/ver1.jpg');">
          <div class="q5u3w8-card-overlay">
            <div class="a1b9c7-card-title">Novice traders mistakes</div>
            <a href="/trademistakes" class="s4v1u8-view-btn">View More</a>
          </div>
        </div>
